...
<head>
    ...
    <link rel="icon" href="../assets/signlogAssets/Logo.png">
    <link rel="stylesheet" href="../styles/signlogpage.css">
...
<body>
    ...
    <div class="navBar">
        <div class="logoClass">
            <img src="../assets/signlogAssets/Logo.png" alt="TalaPuso Logo">
        </div>
    </div>
    ...
    <script src="../scripts/signlogpage.js"></script>
</body>
</html>
